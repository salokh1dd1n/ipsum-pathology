        ...
        <div class="form__wrapper">
            <form class="form__fields" action="{{ route('application.store', app()->getLocale()) }}" method="POST">
                ...
                <fieldset class="uk-fieldset form__content">
                    ...
                    <label class="uk-form-label form__subtitle">@lang('main.applicationForm.callOrSendApplication')</label>
                    <div class="uk-margin form__inputs uk-flex uk-flex-center">
                        <div class="form__input-name uk-width-expand">
                            <input class="uk-input form__input" id="fio" name="fio" placeholder="@lang('main.applicationForm.fio.placeholder')"
                        ...
                        <div class="form__input-tel uk-width-expand">
                            <input class="uk-input form__input" id="tel"
                                   name="phone_number" placeholder="@lang('main.applicationForm.phoneNumber.placeholder')" type="tel"
                                   value="{{ old('phone_number') }}">
                            @error('phone_number')
                            <div class="form__input-error _error">{{ $message }}</div>
                            @enderror
                        </div>
                        <button class="uk-button uk-button-default form__btn" type="submit">@lang('main.applicationForm.submit')</button>
                        @isset($isModal)
