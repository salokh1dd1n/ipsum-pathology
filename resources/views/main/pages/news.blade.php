        ...
        <section class="treatment-nav">
            <div class="uk-container uk-container-center">
                <div class="block__wrapper uk-width-1-1">
                    <!-- Container title -->
                    <h1 class="treatment__title block__title">@lang('main.news.title')</h1>
                    <!-- background pictures -->
                        ...
                        @forelse ($news as $newsItem)
                            <div>
                                <div class="block__card uk-card uk-card-default uk-card-body">
                                    ...
                                    <a href="{{ routeWithLocale('news.show', $newsItem->id) }}" class="block__card-btn btn">@lang('main.moreDetails')</a>
                                </div>
                            </div>
                        @empty
                            <div>
