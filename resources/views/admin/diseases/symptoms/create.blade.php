...
@push('breadcrumb')
    @include('admin.includes.breadcrumb', ['page' => 'Симптомы', 'action' => 'Добавить симптом', 'route' => 'symptoms'])
@endpush
@section('content')
    <div class="card">
        <div class="card-header"><strong>Добавить симптом</strong></div>
        <form class="form-horizontal" action="{{ route('symptoms.store') }}" method="POST">
            @csrf
            <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                rows="6" placeholder="Введите описание">{{ old('description.'.$key) }}</textarea>
